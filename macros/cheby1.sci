...
// Design a Chebyshev type I filter with specified passband ripple.
//
// Syntax
//   [b, a] = cheby1(n, rp, wp)
...
// rp: Non-negative scalar. Passband ripple in dB.
// wp: Positive real value. Normalized digital or analog passband edge(s).
