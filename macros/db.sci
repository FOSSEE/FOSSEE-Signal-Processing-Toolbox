...
// SignalType: Type of signal measurements. Valid entries for SignalType are 'voltage' or 'power'. The entries are not case sensitive. If you specify SignalType as 'power', the elements of X must be nonnegative. Default: 'voltage'
// R: Resistive load in ohms. You can specify resistance only when the SignalType is 'voltage'. Default: 1
// dboutput: The elements of the vector or matrix X converted to decibels (dB). The elements of X are voltage measurements across a resistance of 1 ohm.
//
// Description
